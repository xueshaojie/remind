        ...
        self.init=function(){
            ...
            switch (self.type){
                case "0":
                    ...
                    break;
                case "1":
                    self.$el.html('<div class="file-btn"><a class="btn btn-primary btn-sm" big-button>上传图片</a><input type="file" value="上传图片" data-div="'+self.target+'" data-token="'+ o.token+'" data-bucket="'+o.bucket+'" data-width="'+self.width+'" data-height="'+self.height+'" accept＝".jpg, .jpeg, .png" '+attrStr+'/><input type="hidden" name="'+self.name+'" value="'+self.key+'"/></div>');
                    if(self.img){
                ...
                case "3":
                    var img=getImglist();
                    self.$el.html('<div class="file-btn"><a class="btn btn-primary btn-sm" big-button>上传图片</a><input type="file" value="上传图片" multiple data-div="'+self.target+'" data-token="'+ o.token+'" data-bucket="'+o.bucket+'" data-width="'+self.width+'" data-height="'+self.height+'" accept＝".jpg, .jpeg, .png" '+attrStr+'/><input type="hidden" name="'+self.name+'" value="'+self.key+'"/></div><div class="file-list">'+img+'</div>');
                    break;
                case "4":
