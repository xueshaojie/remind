class InitDb < ActiveRecord::Migration
  ...
  def change
    ...
    create_table "currencies" do |t|
      ...
      t.decimal  "price_usd", :precision => 12, :scale => 2, :default => 0.00, :null => false, comment: "美元价格"
      t.decimal  "price_btc", :precision => 12, :scale => 2, :default => 0.00, :null => false, comment: "比特币价格"
      ...
      t.decimal  "price_cny",  :precision => 12, :scale => 2, :default => 0.00, :null => false, comment: "人民币价格"
